...
if("TRUE" STREQUAL "TRUE")
  set(mytest_SOURCE_PREFIX /home/tndrd/workspaces/kondo/src/mytest)
  set(mytest_DEVEL_PREFIX /home/tndrd/workspaces/kondo/devel)
  set(mytest_INSTALL_PREFIX "")
  set(mytest_PREFIX ${mytest_DEVEL_PREFIX})
else()
  set(mytest_SOURCE_PREFIX "")
  set(mytest_DEVEL_PREFIX "")
  set(mytest_INSTALL_PREFIX /home/tndrd/workspaces/kondo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mytest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tndrd/workspaces/kondo/src/mytest/${idir}'.  ${_report}")
    endif()
    _list_append_unique(mytest_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "webots_ros")
