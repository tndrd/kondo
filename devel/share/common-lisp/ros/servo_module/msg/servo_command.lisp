...
(cl:defmethod cl:initialize-instance :after ((m <servo_command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'servo_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servo_module-msg:<servo_command> is deprecated: use servo_module-msg:servo_command instead.")))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <servo_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_module-msg:names-val is deprecated.  Use servo_module-msg:names instead.")
  (names m))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <servo_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_module-msg:values-val is deprecated.  Use servo_module-msg:values instead.")
  (values m))
